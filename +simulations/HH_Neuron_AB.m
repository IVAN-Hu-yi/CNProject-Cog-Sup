function [final_states, all_results] = HH_Neuron_AB(types, n_pulses, saveVarArg, currentVarArg)
...
for pulse_num = 1:n_pulses
    ...
    results = util.simulate_segment_AB(T_segment, I_Vitro_segment, initial_state, ...
