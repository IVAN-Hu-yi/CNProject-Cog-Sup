function results = simulate_segment_AB(T, I_Vitro, initial_state, dt, C, g_L, V_L, ...
...
for k_t = 2:n_t
    ...
    I_CAN(k_t) = x_CAN(k_t-1) * ( V(k_t-1) - V_CAN );
...
mean_frequency = util.get_frequency(V(:), V_th, window_samples, 'inst', dt);
